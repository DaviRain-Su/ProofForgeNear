...
def entries : Array Entry := #[
  ...
  { name := "NearPromise", digest := "a1a0c808f5efab73" },
  ...
  { name := "NearJsonI64Input", digest := "bb148450caac4382" },
  { name := "NearYield", digest := "fa10ea15d91f8450" },
  { name := "NearTreeMap", digest := "f562f94519896c69" }
]
