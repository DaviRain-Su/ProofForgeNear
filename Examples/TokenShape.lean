...
This is **not** NEP-141 / XRPL wire: no `approve` / allowance (NEAR NEP-141 has none;
approve fixtures stay target-local). The digest is pinned in `Tests/TokenShapeSpec`
and `ProofForge.Wasm.Near.Registry`.
-/
